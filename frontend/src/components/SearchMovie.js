...
const SearchMovie = () => {
  ...
  return (
    <>
      ...
      {
        searchedMovie && searchedMovie.length > 0 ? (<MovieList title={movieName} searchMovie={true} movies={searchedMovie} />) :(<h1 className="flex justify-center mt-[10%] text-3xl">Movie Not Found!!</h1>)
      }
    </>
  );
};
